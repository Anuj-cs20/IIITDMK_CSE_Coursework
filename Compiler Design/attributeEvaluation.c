// Given a real number in bit string representation as input,
// write a program to evaluate it according to the attribute evaluation strategy and
// give the output as a real number in decimal representation.
